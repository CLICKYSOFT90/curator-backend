@extends('front.layouts.master', ['headerClass' => 'header how-it-work-header', 'fullFooter' => true])

@section('title', 'Curator Club - Influencer Profile')

@section('content')
    <!-- CURATOR BANNER SECTION BEGIN -->
    <section class="curator-profile-banner khaby-banner" style="background-image: url('assets/images/cover-images/{{$user->cover_image}}');">
...
@push('front-scripts')
    ...
    <script>
        ...
        // PLAYLIST SLIDER SCRIPT BEGIN
        $('.responsive').slick({
            dots: true,
            arrows: true,
            infinite: true,
            nextArrow:"<span class='ang-right-arrow'><img src='{{asset('assets/front/images/ang2.png')}}'></span>",
            prevArrow:"<span class='ang-left-arrow'><img src='{{asset('assets/front/images/ang1.png')}}'></span>",
            speed: 300,
            slidesToShow: 4,
            slidesToScroll: 1,
            responsive: [
