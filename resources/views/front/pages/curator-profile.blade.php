...
@section('title', 'Curator Club - Curator Profile')

@section('content')
    <!-- CURATOR BANNER SECTION BEGIN -->
    <section class="curator-profile-banner cur-pro-ban" style="background-image: url('assets/images/cover-images/{{$user->cover_image}}');">
