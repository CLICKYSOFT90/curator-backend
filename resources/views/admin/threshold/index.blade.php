...
@section('title', 'Influencer Threshold Chart')
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <div class="card">
            <div class="card-header">
                <h5 class="float-start">Influencer Threshold Chart</h5>
                <a href="{{route('add.threshold')}}" class="btn btn-primary float-end redirect-btn">Add +</a>
            </div>
    ...
    <script>
        $(function (){
            $('#custom_datatable').DataTable({
                ...
                "orderMulti": true,
                "scrollX": true,
                "ajax": "{{ route('manage.threshold') }}",
                "columns": [
                    { "data" : "tier","title" : "Tier", "orderable": true, "searchable": true },
                    { "data" : "price","title" : "Price", "orderable": true, "searchable": true },
                    { "data" : "coins", "title" : "Coins", "orderable": false, "searchable": true },
