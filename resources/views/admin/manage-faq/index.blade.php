    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <div class="card">
            <div class="card-header">
                <h5 class="float-start">Manage Faqs</h5>
                <a href="{{route('faq.add')}}" class="btn btn-primary float-end redirect-btn">Add +</a>
            </div>
    ...
    <script>
        $(function (){
            $('#custom_datatable').DataTable({
                ...
                "orderMulti": true,
                "scrollX": true,
                "ajax": "{{ route('manage.faq') }}",
                "columns": [
                    { "data" : "question","title" : "Question", "orderable": true, "searchable": true },
                    { "data" : "answer","title" : "Answer", "orderable": true, "searchable": true },
                    { "data" : "is_active", "title" : "Active/InActive", "orderable": false, "searchable": false },
                    { "data" : "is_popular", "title" : "Popular Topic", "orderable": false, "searchable": false },
                    { "data" : "is_global", "title" : "Using Global", "orderable": false, "searchable": false },
        ...
        function changePopularStatus(route) {
            axios.get(route).then(function (response) {
                swal({
                    title: response.data.msg,
                    icon: "success",
        ...
        function changeGlobalStatus(route) {
            axios.get(route).then(function (response) {
                swal({
                    title: response.data.msg,
                    icon: "success",
