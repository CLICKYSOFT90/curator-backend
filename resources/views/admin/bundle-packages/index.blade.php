    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <div class="card">
            <div class="card-header">
                <h5 class="float-start">Bundle Packages</h5>
                <a href="{{route('add.bundle.packages')}}" class="btn btn-primary float-end redirect-btn">Add +</a>
            </div>
    ...
    <script>
        $(function (){
            $('#custom_datatable').DataTable({
                ...
                "orderMulti": true,
                "scrollX": true,
                "ajax": "{{ route('manage.bundle.packages') }}",
                "columns": [
                    { "data" : "package_name","title" : "Package Name", "orderable": true, "searchable": true },
                    { "data" : "package_price","title" : "Package Price", "orderable": true, "searchable": true },
