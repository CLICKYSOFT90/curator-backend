...
@section('title', 'Add Bundle Packages')
...
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        <div class="row">
            <div class="col-md-12">
                <div class="card mb-4">
                    <h5 class="card-header">Add Bundle Packages</h5>
                    <div class="card-body">
                        <form action="{{ route('add.bundle.packages.data') }}" method="POST">
                            @csrf
                            ...
                            <div class="row mt-3">
                                ...
                                <div class="col-md-6 mb-6">
                                    ...
                                    <input type="text" class="form-control" name="package_price" value="{{old('package_price')}}" placeholder="Enter Package Price"/>
                                </div>
                            </div>
                            <div class="row mt-3">
                                <div class="col-md-6 mb-6">
