    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <div class="card">
            <div class="card-header">
                <h5 class="float-start">Individual Coin</h5>
                <a href="{{route('add.individual.coin')}}" class="btn btn-primary float-end redirect-btn">Add +</a>
            </div>
    ...
    <script>
        $(function (){
            $('#custom_datatable').DataTable({
                ...
                "orderMulti": true,
                "scrollX": true,
                "ajax": "{{ route('manage.individual.coin') }}",
                "columns": [
                    { "data" : "coins","title" : "Coins", "orderable": true, "searchable": true },
                    { "data" : "elite", "title" : "Elite", "orderable": false, "searchable": true },
                    { "data" : "user_type", "title" : "User Type", "orderable": false, "searchable": true },
