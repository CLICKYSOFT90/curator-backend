    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <div class="card">
            <div class="card-header">
                <h5 class="float-start">Ground Floor Ticket Prices Detail</h5>
                <a href="{{route('add.groud.floor.ticket.price')}}" class="btn btn-primary float-end redirect-btn">Add +</a>
            </div>
    ...
    <script>
        $(function (){
            $('#custom_datatable').DataTable({
                ...
                "orderMulti": true,
                "scrollX": true,
                "ajax": "{{ route('manage.groud.floor.ticket.price') }}",
                "columns": [
                    { "data" : "campaign_days","title" : "Campaign Days", "orderable": true, "searchable": true },
