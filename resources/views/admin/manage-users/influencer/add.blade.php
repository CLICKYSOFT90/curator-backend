...
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        <div class="row">
            <div class="col-md-12">
                <div class="card mb-4">
                    <h5 class="card-header">Add Influencer</h5>
                    <div class="card-body">
                        <form action="{{ route('add.influencer.data') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            ...
                            <input type="hidden" name="is_influencer" value="1" />
                        </form>
                    </div>
                </div>
            </div>
