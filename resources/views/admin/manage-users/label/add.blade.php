...
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        <div class="row">
            <div class="col-md-12">
                <div class="card mb-4">
                    <h5 class="card-header">Add Label</h5>
                    <div class="card-body">
                        <form action="{{ route('add.label.data') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            ...
                            <input type="hidden" name="is_label" value="1" />
                            <div class="row mt-3">
                                <div class="col-md-12">
                                    <div class="card">
                                        ...
                                        <div class="form-repeater card-body">
                                            <div id="dataRepeaterList">
                                                <div id="dataRepeaterItem">
                                                    @if ($errors->any())
                                                        @if(old('labelArtist'))
                                                            @foreach (old('labelArtist') as $key => $labelArtist)
                                                                <div class="row">
                                                                    <div class="mb-3 col-lg-6 col-xl-3 col-12 mb-0">
                                                                        <label class="form-label" for="artist_firstname_{{$key}}">Firstname</label>
                                                                        <input type="text" class="form-control" name="labelArtist[{{$key}}][artist_firstname]" id="artist_firstname_{{$key}}" value="{{$labelArtist['artist_firstname']}}" placeholder="Enter firstname" />
                                                                    </div>
                                                                    <div class="mb-3 col-lg-6 col-xl-3 col-12 mb-0">
                                                                        <label class="form-label" for="artist_lastname_{{$key}}">Lastname</label>
                                                                        <input type="text" class="form-control" name="labelArtist[{{$key}}][artist_lastname]" id="artist_lastname_{{$key}}" value="{{$labelArtist['artist_lastname']}}" placeholder="Enter lastname" />
                                                                    </div>
                                                                    <div class="mb-3 col-lg-6 col-xl-3 col-12 mb-0">
                                                                        <label class="form-label" for="artist_username_{{$key}}">Username</label>
                                                                        <input type="text" class="form-control" name="labelArtist[{{$key}}][artist_username]" id="artist_username_{{$key}}" value="{{$labelArtist['artist_username']}}" placeholder="Enter username" />
                                                                    </div>
                                                                    <div class="mb-3 col-lg-6 col-xl-3 col-12 mb-0">
                                                                        <label class="form-label" for="artist_email_{{$key}}">Email</label>
                                                                        <input type="text" class="form-control" name="labelArtist[{{$key}}][artist_email]" id="artist_email_{{$key}}" value="{{$labelArtist['artist_email']}}" placeholder="Enter email" />
                                                                    </div>
